...
import { createOrder,emptytUserCart } from '../functions/user'
...

        {
            !succeeded && <div>
                {coupon && totalAfterDiscount !==undefined ? (
                    <p className='laert alert-success'>{`Total after discount:${totalAfterDiscount}`}</p>
            ...
            <div className='text-center pb-5'>
                ...
                <form id="paymnt-form" className='stripe-form' onSubmit={handleSubmit}>
                   ...
                   <p className={succeeded ? 'result-message':"result-messge hidden"}>
